    ...
    <div v-else class="space-y-8 animate-in fade-in duration-300">
      ...
      <section v-if="auth.isManager && managerStats" class="space-y-6 pt-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <!-- Maintenance Devices -->
          <router-link to="/m/home/admin-assets?status=under_maintenance" class="glass-card flex items-center justify-between hover:border-indigo-500/50 transition-all group">
            <div>
          ...
          <div class="bg-white border border-slate-200 rounded-2xl p-6 space-y-4 col-span-1">
            ...
            <div class="space-y-3">
              <router-link 
                ...
                :key="item.id" 
                :to="`/m/home/admin-assets?status=under_maintenance&search=${item.item_code}`" 
