    ...
    <div class="relative overflow-hidden bg-white border border-slate-200 rounded-2xl p-6 md:p-8 shadow-xl">
      ...
      <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div class="flex items-center gap-2 shrink-0">
          ...
          <router-link v-if="auth.isAdmin || auth.isManager" to="/admin" class="btn-primary flex items-center gap-2 px-5 py-3 text-xs font-bold shadow-indigo-600/20">
    ...
    <div v-else class="space-y-8 animate-in fade-in duration-300">
      ...
      <section v-if="auth.isAdmin && adminStats" class="space-y-6 pt-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <router-link to="/admin/approvals" class="glass-card flex items-center justify-between hover:border-indigo-500/50 transition-all group">
            <div>
          ...
          <router-link to="/admin/users" class="glass-card flex items-center justify-between hover:border-indigo-500/50 transition-all group">
            <div>
          ...
          <!-- Total Assets -->
          <router-link to="/admin/assets" class="glass-card flex items-center justify-between hover:border-indigo-500/50 transition-all group">
            <div>
          ...
          <div class="bg-white border border-slate-200 rounded-2xl p-6 space-y-4">
            ...
            <div class="space-y-3">
              <router-link 
                ...
                :key="cat.name" 
                :to="`/admin/assets?category=${cat.name}`" 
          ...
          <div class="bg-white border border-slate-200 rounded-2xl p-6 space-y-4">
            ...
            <div class="space-y-3">
              <router-link 
                ...
                :key="dept.name" 
                :to="`/admin/assets?dept=${dept.name}`" 
                class="block space-y-1 hover:bg-slate-50 p-2 rounded-xl transition-all group"
              >
                <div class="flex justify-between text-xs font-semibold">
      ...
      <section v-if="auth.isManager && managerStats" class="space-y-6 pt-2">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
          <!-- Maintenance Devices -->
          <router-link :to="`/admin/assets?dept=${managerStats.dept}&status=under_maintenance`" class="glass-card flex items-center justify-between hover:border-indigo-500/50 transition-all group">
            <div>
          ...
          <router-link :to="`/admin/assets?dept=${managerStats.dept}&filter=low_stock`" class="glass-card flex items-center justify-between hover:border-indigo-500/50 transition-all group">
            <div>
          ...
          <div class="bg-white border border-slate-200 rounded-2xl p-6 space-y-4 col-span-1">
            ...
            <div class="space-y-3">
              <router-link 
                ...
                :key="cat.name" 
                :to="`/admin/assets?dept=${managerStats.dept}&category=${cat.name}`" 
          ...
          <div class="bg-white border border-slate-200 rounded-2xl p-6 space-y-4 col-span-1">
            ...
            <div class="space-y-3">
              <router-link 
                ...
                :key="item.id" 
                :to="`/admin/assets?search=${item.item_code}`" 
